...
Res HttpRouter::handle_request(const Req& request) const {
    ...
    return Res::not_found("The requested resource was not found");
}
...
Res HttpRouter::execute_with_middleware(const Req& request, const Handler& handler) const {
